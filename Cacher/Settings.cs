...
{
    [Serializable]
    public class CacherSettings :NotificationObject
    {
        private static string filePath;

        public static CacherSettings Current { get; private set; }
...
return;
        ...
        public CacherSettings ()
        {
            _CacheFolder = Directory.GetCurrentDirectory() + @"\HoppoPlugin\KanColleCache";
                _CacheEnabled = true;
                _HackEnabled = true;
